...
| Android app (React Native + Kotlin) | `apps/mobile` | In progress (2026-09-24, ADR 0010). JS client and Kotlin sources exist. APK proof is GitHub Actions, not this sandbox. |
